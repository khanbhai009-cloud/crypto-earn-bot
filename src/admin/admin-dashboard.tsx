...
const AdminDashboard = () => {
  const [withdrawalLimit, setWithdrawalLimit] = useState(100);
  ...
  const saveLimit = () => {
    // TODO: call backend AdminSettings.setWithdrawalLimit
    alert(`Withdrawal limit set to ${withdrawalLimit} coins`);
  };

  return (
    <div style={{ backgroundColor: '#121212', color: '#ffffff', minHeight: '100vh', padding: '20px', fontFamily: 'Arial' }}>
